...
(
    ...
    `file_key`         VARCHAR(64)                    NOT NULL COMMENT '文件唯一标识(同一用户不允许重复)',
    ...
    INDEX `IDX_File_On_FileKey` (`file_key`(32)),
    UNIQUE `UK_File_On_FileKey_CreatedById` (`file_key`(32), `created_by_id`),
