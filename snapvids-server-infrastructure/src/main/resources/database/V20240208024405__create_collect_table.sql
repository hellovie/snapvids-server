...
(
    ...
    CONSTRAINT `FK_Collect_User_On_UserId` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
    CONSTRAINT `FK_Collect_Creation_On_CreationId` FOREIGN KEY (`creation_id`) REFERENCES `creation` (`id`)
) ENGINE = InnoDB
