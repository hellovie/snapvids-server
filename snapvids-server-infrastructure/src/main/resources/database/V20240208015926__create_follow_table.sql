...
(
    ...
    CONSTRAINT `FK_Follow_User_On_FollowingId` FOREIGN KEY (`following_id`) REFERENCES `user` (`id`),
    CONSTRAINT `FK_Follow_User_On_FollowerId` FOREIGN KEY (`follower_id`) REFERENCES `user` (`id`)
) ENGINE = InnoDB
