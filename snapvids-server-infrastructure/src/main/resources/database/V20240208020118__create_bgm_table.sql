...
(
    ...
    CONSTRAINT `FK_Bgm_File_On_CoverId` FOREIGN KEY (`cover_id`) REFERENCES `file` (`id`),
    CONSTRAINT `FK_Bgm_File_On_MusicId` FOREIGN KEY (`music_id`) REFERENCES `file` (`id`),
    CONSTRAINT `FK_Bgm_User_On_AuthorId` FOREIGN KEY (`author_id`) REFERENCES `user` (`id`)
) ENGINE = InnoDB
